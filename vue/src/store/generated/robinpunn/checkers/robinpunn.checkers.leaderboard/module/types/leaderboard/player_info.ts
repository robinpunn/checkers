...
export const protobufPackage = "robinpunn.checkers.leaderboard";
...
export const PlayerInfo = {
  encode(message: PlayerInfo, writer: Writer = Writer.create()): Writer {
    ...
    if (message.dateUpdated !== "") {
      writer.uint32(42).string(message.dateUpdated);
    }
    return writer;
  },
  ...
  fromJSON(object: any): PlayerInfo {
    ...
    if (object.dateUpdated !== undefined && object.dateUpdated !== null) {
      message.dateUpdated = String(object.dateUpdated);
    } else {
      message.dateUpdated = "";
    }
    return message;
  ...
  toJSON(message: PlayerInfo): unknown {
    ...
    message.dateUpdated !== undefined &&
      (obj.dateUpdated = message.dateUpdated);
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<PlayerInfo>): PlayerInfo {
    ...
    if (object.dateUpdated !== undefined && object.dateUpdated !== null) {
      message.dateUpdated = object.dateUpdated;
    } else {
      message.dateUpdated = "";
    }
    return message;
