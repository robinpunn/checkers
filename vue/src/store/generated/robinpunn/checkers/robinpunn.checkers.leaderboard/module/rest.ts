...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/robinpunn/checkers/leaderboard/board
   */
  queryBoard = (params: RequestParams = {}) =>
    this.request<LeaderboardQueryGetBoardResponse, RpcStatus>({
      path: `/robinpunn/checkers/leaderboard/board`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/robinpunn/checkers/leaderboard/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<LeaderboardQueryParamsResponse, RpcStatus>({
      path: `/robinpunn/checkers/leaderboard/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/robinpunn/checkers/leaderboard/player_info
   */
  queryPlayerInfoAll = (
    query?: {
    ...
    this.request<LeaderboardQueryAllPlayerInfoResponse, RpcStatus>({
      path: `/robinpunn/checkers/leaderboard/player_info`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/robinpunn/checkers/leaderboard/player_info/{index}
   */
  queryPlayerInfo = (index: string, params: RequestParams = {}) =>
    this.request<LeaderboardQueryGetPlayerInfoResponse, RpcStatus>({
      path: `/robinpunn/checkers/leaderboard/player_info/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
