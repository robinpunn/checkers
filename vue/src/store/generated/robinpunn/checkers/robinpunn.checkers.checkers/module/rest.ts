...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/robinpunn/checkers/checkers/can_play_move/{gameIndex}/{player}/{fromX}/{fromY}/{toX}/{toY}
   */
  queryCanPlayMove = (
    gameIndex: string,
    player: string,
    ...
    this.request<CheckersQueryCanPlayMoveResponse, RpcStatus>({
      path: `/robinpunn/checkers/checkers/can_play_move/${gameIndex}/${player}/${fromX}/${fromY}/${toX}/${toY}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/robinpunn/checkers/checkers/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<CheckersQueryParamsResponse, RpcStatus>({
      path: `/robinpunn/checkers/checkers/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/robinpunn/checkers/checkers/stored_game
   */
  queryStoredGameAll = (
    query?: {
    ...
    this.request<CheckersQueryAllStoredGameResponse, RpcStatus>({
      path: `/robinpunn/checkers/checkers/stored_game`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/robinpunn/checkers/checkers/stored_game/{index}
   */
  queryStoredGame = (index: string, params: RequestParams = {}) =>
    this.request<CheckersQueryGetStoredGameResponse, RpcStatus>({
      path: `/robinpunn/checkers/checkers/stored_game/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/robinpunn/checkers/checkers/system_info
   */
  querySystemInfo = (params: RequestParams = {}) =>
    this.request<CheckersQueryGetSystemInfoResponse, RpcStatus>({
      path: `/robinpunn/checkers/checkers/system_info`,
      method: "GET",
      format: "json",
      ...params,
    });
